...
`@HttpExchange`는 사실 Spring Framework 6.0부터 있었다. Boot 4에서 달라진 건 auto-configuration이 완성돼 공식 권장 패턴으로 자리 잡았다는 것이다. 스트리밍이나 멀티파트 같은 복잡한 케이스는 여전히 WebClient를 직접 쓰는 게 낫다.
