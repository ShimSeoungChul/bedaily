...
<Figure caption="흩어져 있던 HTTP 클라이언트 선택지를 @HttpExchange 선언적 인터페이스로 통합 — 스트리밍·멀티파트는 여전히 WebClient 직접 사용">
  <svg viewBox="0 0 760 225" fontFamily="ui-monospace, monospace" role="img" aria-label="HTTP 클라이언트 통합">
    <defs><marker id="b4A" markerWidth="9" markerHeight="9" refX="5" refY="4.5" orient="auto"><path d="M0,0 L9,4.5 L0,9 Z" fill="var(--text-subtle)" /></marker></defs>
    <rect x="30" y="34" width="200" height="44" rx="7" fill="#e8a85c1f" stroke="#e8a85c" strokeOpacity=".5" /><text x="130" y="52" textAnchor="middle" fontSize="10.5" fill="var(--text)">RestTemplate</text><text x="130" y="67" textAnchor="middle" fontSize="9" fill="#e8a85c">유지보수 모드</text>
    <rect x="30" y="93" width="200" height="44" rx="7" fill="var(--bg-muted)" stroke="var(--border)" /><text x="130" y="111" textAnchor="middle" fontSize="10.5" fill="var(--text)">WebClient</text><text x="130" y="126" textAnchor="middle" fontSize="9" fill="var(--text-subtle)">reactive 스택 필요</text>
    <rect x="30" y="152" width="200" height="44" rx="7" fill="var(--bg-muted)" stroke="var(--border)" /><text x="130" y="170" textAnchor="middle" fontSize="10.5" fill="var(--text)">OpenFeign</text><text x="130" y="185" textAnchor="middle" fontSize="9" fill="var(--text-subtle)">서드파티</text>
    <rect x="440" y="80" width="290" height="70" rx="9" fill="#7fc99a1f" stroke="#7fc99a" strokeOpacity=".6" /><text x="585" y="108" textAnchor="middle" fontSize="12" fill="#7fc99a" fontWeight="600">@HttpExchange</text><text x="585" y="128" textAnchor="middle" fontSize="9.5" fill="var(--text-muted)">선언적 인터페이스 · Boot 4 자동구성</text>
    <line x1="230" y1="56" x2="438" y2="100" stroke="var(--text-subtle)" strokeWidth="1.2" markerEnd="url(#b4A)" />
    <line x1="230" y1="115" x2="438" y2="115" stroke="var(--text-subtle)" strokeWidth="1.2" markerEnd="url(#b4A)" />
    <line x1="230" y1="174" x2="438" y2="130" stroke="var(--text-subtle)" strokeWidth="1.2" markerEnd="url(#b4A)" />
    <text x="380" y="212" textAnchor="middle" fontSize="9.5" fill="var(--text-subtle)">스트리밍·대용량 멀티파트는 여전히 WebClient 직접 사용</text>
  </svg>
</Figure>
